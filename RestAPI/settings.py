...
SECRET_KEY = 'django-insecure-ek*jzfu*x((%8g5zpac@g)n$96og=n6=68wlgb1i*1wi7vnhsh'
...
ACCOUNT_EMAIL_VERIFICATION = 'optional'  # Users can log in without verifying their email
ACCOUNT_EMAIL_REQUIRED = True  # Email is required for registration
ACCOUNT_AUTHENTICATED_LOGIN_REDIRECTS = True  # Redirect authenticated users after login
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'AUTH_PARAMS': {
            'access_type': 'offline',  # Optional: if you need a refresh token
        }
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'swdeve66@gmail.com'  
EMAIL_HOST_PASSWORD = 'wdrbfvyocgpeegah' 
